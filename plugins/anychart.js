(function() {
  ...
  var acConfig = {
     ...
     *
     * Read more: https://docs.anychart.com/Quick_Start/Credits
     */
    // credits: {
    //   licenseKey: "",
    //
     ...
     * Default theme
     *
     * To use additional themes you should include appropriate theme scripts to your dashboard.
     ...
     * 
     * Read more: https://docs.anychart.com/Appearance_Settings/Themes
     */
    // defaultTheme: "",
     ...
     *
     * To use additional locales for `inputLocale` or `outputLocale` options
     * you should include appropriate locale scripts to your dashboard.
     * You can find all additional scripts here: https://www.anychart.com/download/cdn
     *
     * For example, to be able to use the 'fr-fr' for `inputLocale` or `outputLocale` options
     * you should include this script: https://cdn.anychart.com/releases/8.5.0/locales/fr-fr.js
     *
     * Read more: https://docs.anychart.com/Common_Settings/Localization
     */
    // localization: {
    //   inputLocale: "",
    //   outputLocale: "",
